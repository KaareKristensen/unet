...
def UNet(pretrained_weights = None,input_size = (608,576,1), transfer_learn = False, kernel_initializer = 'he_normal'):
    trainable = not transfer_learn
    inputs = Input(input_size)
    conv1 = Conv2D(64, 3, activation = 'relu', padding = 'same', kernel_initializer = kernel_initializer, name='conv_1_1', trainable=trainable)(inputs)
    conv1 = Conv2D(64, 3, activation = 'relu', padding = 'same', kernel_initializer = kernel_initializer, name='conv_1_2', trainable=trainable)(conv1)
    pool1 = MaxPooling2D(pool_size=(2, 2))(conv1)
    conv2 = Conv2D(128, 3, activation = 'relu', padding = 'same', kernel_initializer = kernel_initializer, name='conv_2_1', trainable=trainable)(pool1)
    conv2 = Conv2D(128, 3, activation = 'relu', padding = 'same', kernel_initializer = kernel_initializer, name='conv_2_2', trainable=trainable)(conv2)
    pool2 = MaxPooling2D(pool_size=(2, 2))(conv2)
    conv3 = Conv2D(256, 3, activation = 'relu', padding = 'same', kernel_initializer = kernel_initializer, name='conv_3_1', trainable=trainable)(pool2)
    conv3 = Conv2D(256, 3, activation = 'relu', padding = 'same', kernel_initializer = kernel_initializer, name='conv_3_2', trainable=trainable)(conv3)
    pool3 = MaxPooling2D(pool_size=(2, 2))(conv3)
    conv4 = Conv2D(512, 3, activation = 'relu', padding = 'same', kernel_initializer = kernel_initializer, name='conv_4_1', trainable=trainable)(pool3)
    conv4 = Conv2D(512, 3, activation = 'relu', padding = 'same', kernel_initializer = kernel_initializer, name='conv_4_2', trainable=trainable)(conv4)
    drop4 = Dropout(0.5)(conv4)
    pool4 = MaxPooling2D(pool_size=(2, 2))(drop4)

    conv5 = Conv2D(1024, 3, activation = 'relu', padding = 'same', kernel_initializer = kernel_initializer, name='conv_5_1', trainable=trainable)(pool4)
    conv5 = Conv2D(1024, 3, activation = 'relu', padding = 'same', kernel_initializer = kernel_initializer, name='conv_5_2', trainable=trainable)(conv5)
    ...
    if(pretrained_weights):
        model.load_weights(pretrained_weights, by_name=transfer_learn)
